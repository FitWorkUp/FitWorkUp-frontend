...
add_labeled(doc, "Fundamentação: ", "decisões de interface podem induzir interpretações ou escolhas que favorecem o sistema em detrimento da compreensão do usuário. A teoria da comparação social explica que avaliações pessoais são influenciadas pela comparação com outras pessoas, o que torna a apresentação do ranking relevante para a motivação e para a cultura criada pelo aplicativo (GRAY et al., 2018; FESTINGER, 1954).")
...
add_labeled(doc, "Fundamentação: ", "a documentação de acessibilidade do Android recomenda alvos de toque de pelo menos 48 dp. Pela lei de Fitts, alvos menores e mais distantes exigem maior precisão e tendem a aumentar o tempo e a probabilidade de erro durante a seleção (ANDROID DEVELOPERS, 2026; FITTS, 1954).")
...
add_labeled(doc, "Fundamentação: ", "as heurísticas de visibilidade do estado, design estético e minimalista e reconhecimento em vez de memorização recomendam que ações persistentes não ocultem informações relevantes. A teoria da carga cognitiva sustenta a redução de demandas desnecessárias; os princípios de agrupamento da Gestalt favorecem separar dados diários, históricos e ações por proximidade e hierarquia (NIELSEN, 2024; SWELLER, 1988; WERTHEIMER, 1923).")
...
references = [
    ...
    "WERTHEIMER, Max. Untersuchungen zur Lehre von der Gestalt II. Psychologische Forschung, v. 4, p. 301–350, 1923. DOI: https://doi.org/10.1007/BF00410640.",
]
